...
def draw_keypoint(img, cls_skeleton, bbox=None):
    ...
    img = cv2.circle(img, (int(cls_skeleton[0]), int(cls_skeleton[1])), 2, (0,0,255), 2)
    img = cv2.circle(img, (int(cls_skeleton[16*3]), int(cls_skeleton[16*3+1])), 2, (0,255,255), 2)
    img = cv2.circle(img, (int(cls_skeleton[15*3]), int(cls_skeleton[15*3+1])), 2, (255,0,255), 2)
    img = cv2.circle(img, (int(cls_skeleton[9*3]), int(cls_skeleton[9*3+1])), 2, (255,255,255), 2)
    img = cv2.circle(img, (int(cls_skeleton[10*3]), int(cls_skeleton[10*3+1])), 2, (0,0,255), 2)
    #print('##', cls_skeleton[9*3], cls_skeleton[9*3+1])
